...
A simple example application, _raftexample_, is also available to help illustrate how to use this package in practice: https://github.com/adodon2go/etcd/tree/master/contrib/raftexample
...
- [etcd](https://github.com/adodon2go/etcd) A distributed reliable key-value store
