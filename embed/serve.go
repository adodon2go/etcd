...
import (
	...
	"github.com/adodon2go/etcd/etcdserver/api/v3election/v3electionpb"
	v3electiongw "github.com/adodon2go/etcd/etcdserver/api/v3election/v3electionpb/gw"
	"github.com/adodon2go/etcd/etcdserver/api/v3lock"
	"github.com/adodon2go/etcd/etcdserver/api/v3lock/v3lockpb"
	v3lockgw "github.com/adodon2go/etcd/etcdserver/api/v3lock/v3lockpb/gw"
	"github.com/adodon2go/etcd/etcdserver/api/v3rpc"
	etcdservergw "github.com/adodon2go/etcd/etcdserver/etcdserverpb/gw"
