...
import (
	...
	"github.com/adodon2go/etcd/alarm"
	...
	"github.com/adodon2go/etcd/pkg/schedule"
	"github.com/adodon2go/etcd/pkg/types"
	"github.com/adodon2go/etcd/pkg/wait"
...
var (
	plog = capnslog.NewPackageLogger("github.com/adodon2go/etcd", "etcdserver")
