...
[![Go Report Card](https://goreportcard.com/badge/go.etcd.io/etcd/v3?style=flat-square)](https://goreportcard.com/report/go.etcd.io/etcd/v3)
...
[![Godoc](http://img.shields.io/badge/go-documentation-blue.svg?style=flat-square)](https://godoc.org/go.etcd.io/etcd/v3)
[![Releases](https://img.shields.io/github/release/coreos/etcd/all.svg?style=flat-square)](https://go.etcd.io/etcd/v3/releases)
[![LICENSE](https://img.shields.io/github/license/coreos/etcd.svg?style=flat-square)](https://go.etcd.io/etcd/v3/blob/master/LICENSE)
...
[etcdctl]: https://go.etcd.io/etcd/v3/tree/master/etcdctl
...
[github-release]: https://go.etcd.io/etcd/v3/releases/
...
To run an etcd cluster on Kubernetes, try [etcd operator](https://go.etcd.io/etcd/v3-operator).
...
- Planning/Roadmap: [milestones](https://go.etcd.io/etcd/v3/milestones), [roadmap](./ROADMAP.md)
- Bugs: [issues](https://go.etcd.io/etcd/v3/issues)
